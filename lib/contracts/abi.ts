export const CHAIN_CAPSULE_ABI = [
  {
    "inputs": [],
    ...
    "outputs": [
      {
        "components": [
          ...
          { "internalType": "bool", "name": "isPublic", "type": "bool" },
          { "internalType": "bool", "name": "bnbWithdrawn", "type": "bool" },
          { "internalType": "address", "name": "recipient", "type": "address" },
          { "internalType": "uint256", "name": "openedAt", "type": "uint256" }
        ],
        "internalType": "struct ChainCapsule.Capsule",
        "name": "",
        "type": "tuple"
      }
    ],
